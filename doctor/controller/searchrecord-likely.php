      ...
      <td class="text-center">
        <div class="btn-group">
          ...
          if($value['confirm_status']==1){
            ...
            <button class="btn btn-xs btn-app-teal" type="button" data-toggle="tooltip" title="Edit Client" disable onclick="createsession('<?php print $value['record_id'];?>')"><i class="ion-edit"></i></button>
