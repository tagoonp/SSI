                            ...
                            <div class="card">
                              ...
                              <div class="card-block" style="padding-top: 30px;">
                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    ...
                                    <tbody>
                                      <?php
                                      $strSQL = sprintf("SELECT * FROM ".$tbprefix."registerrecord aa inner join ".$tbprefix."delivery bb on aa.record_id = bb.record_id WHERE aa.username in (SELECT a.username FROM ".$tbprefix."useraccount a inner join ".$tbprefix."userdescription b on a.username = b.username WHERE b.institute_id = '%s') and aa.confirm_status = 0 and bb.ba_username = '%s' ORDER BY aa.date_adm DESC ", mysql_real_escape_string($valueUserinfo['institute_id']), mysql_real_escape_string($_SESSION[$sessionName.'sessUsername']));
                                      // print $strSQL;
                                        ...
                                        foreach ($result as $value) {
                                          ...
                                          <tr>
                                              ...
                                              <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="View" onclick="changepage('view-data.php?record_id=<?php print $value['record_id'];?>')"><i class="ion-search"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit" onclick="createsession('<?php print $value['record_id'];?>')"><i class="ion-edit"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Confirm record" onclick="changepage_confirm2('controller/confirm_record.php?record_id=<?php print $value['record_id'];?>')"><i class="ion-checkmark"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove"><i class="ion-close"></i></button>
                                                  </div>
                                              </td>
                                          </tr>
                                          <?php
