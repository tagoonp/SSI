            ...
            <div class="card">
              ...
              <div class="card-block" style="padding-top: 30px;">
                ...
                <div class="form-group" style="padding-top: 20px;">
                  <div class="col-sm-6">
                      <div class="form-material">
                          <input class="form-control" type="text" id="txt-mt-ba" name="txt-mt-ba" placeholder="Please choose or enter full name of birth attendant" />
                          <label for="material-text">Name of birth attendant&nbsp;&nbsp;&nbsp;&nbsp;
                            <button class="btn btn-xs btn-app-teal-outline" data-toggle="modal" data-target="#modal-ba" id="btnChooseBA" type="button" onclick="fillMedalData2('txt-mt-ba')"><i class="ion-android-arrow-dropdown"></i> Choose</button>
                          </label>
                      </div>
                  </div>
                  <div class="col-sm-6" style="display:;">
                    <div class="form-material">
                        <input class="form-control" type="text" id="txt-mt-ba-id" name="txt-mt-ba-id" placeholder="ID of birth attendant" />
                        <p style="font-size: 0.8em; padding-top: 10px; color: red;">
                          ** Enter ID issued by ministry of public Health
                        </p>
                    </div>
                  </div>
                </div>
