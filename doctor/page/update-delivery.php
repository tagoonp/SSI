                  ...
                  <div class="col-sm-6">
                      <div class="form-material">
                          ...
                          <label for="material-text">Name of birth attendant&nbsp;&nbsp;&nbsp;&nbsp;
                            <button class="btn btn-xs btn-app-teal-outline" data-toggle="modal" data-target="#modal-ba" type="button" id="btnChooseBA" onclick="fillMedalData2('txt-mt-ba')"><i class="ion-android-arrow-dropdown"></i> Choose</button>
                          </label>
                      </div>
                  </div>
                  <div class="col-sm-6" style="display:;">
                    <div class="form-material">
                        <input class="form-control" type="text" id="txt-mt-ba-id" name="txt-mt-ba-id" placeholder="ID of birth attendant" value="<?php print $result[0]['ba_username'];?>" />
