<nav class="drawer-main">
    <ul class="nav nav-drawer">
        ...
        <li class="nav-item">
            <a href="institute.php"><i class="fa fa-hospital-o"></i> Hospital / Institutes</a>
        </li>

        <li class="nav-item nav-item-has-subnav">
            <a href="javascript:void(0)"><i class="fa fa-gear"></i> Trust center</a>
            <ul class="nav nav-subnav">

                <li>
                    <a href="trust-ba.php">Doctor / BA </a>
                </li>

                <li>
                    <a href="trust-institute.php">Institute / Hospital</a>
                </li>
        ...
        <li class="nav-item">
            <a href="search-record.php"><i class="ion-search"></i> Birth registry records</a>
        </li>
