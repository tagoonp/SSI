                        ...
                        <div class="col-sm-12 col-lg-12">
                          <div class="card">
                              ...
                              <div class="card-block">
                                <form class="js-validation-material form-horizontal m-t-sm" action="controller/user-update.php" method="post">
                                <div class="row">
                                  <div class="col-sm-12">
                                      ...
                                      <div class="form-group" style="display:none;">
                                          <div class="col-xs-12">
                                              <div class="form-material">
                                                  <input class="form-control" type="text" readonly id="txt-username" name="txt-username" placeholder="Enter user's email address..." value="<?php print $resultUser[0]['username'];?>" />
                                                  <label for="register5-firstname">Username </label>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="row" style="padding-top: 10px;">
                                        <div class="col-sm-6">
                                          <div class="form-group">
                                              <div class="col-xs-12">
                                                  <div class="form-material">
                                                      <input class="form-control" type="text" id="txt-fname" name="txt-fname" placeholder="Enter name of user..." value="<?php print $resultUser[0]['fname'];?>" />
                                        ...
                                        <div class="col-sm-6">
                                          <div class="form-group">
                                              <div class="col-xs-12">
                                                  <div class="form-material">
                                                      <input class="form-control" type="text" id="txt-lname" name="txt-lname" placeholder="Enter surname of user.."value="<?php print $resultUser[0]['lname'];?>" />
                                      ...
                                      <div class="form-group">
                                          <div class="col-xs-12">
                                              <div class="form-material">
                                                  <input class="form-control" type="text" id="txt-email" name="txt-email" placeholder="Enter user's email address..." value="<?php print $resultUser[0]['email'];?>" />
                                      ...
                                      <div class="form-group">
                                          <div class="col-xs-12">
                                              <div class="form-material">
                                                  <input class="form-control" type="text" id="txt-phone" name="txt-phone" placeholder="Enter user's phone number..." value="<?php print $resultUser[0]['phone'];?>" />
                                      ...
                                      <div class="form-group">
                                        <div class="col-xs-12">
                                          <div class="form-material">
                                              <textarea class="form-control" name="txt-address" id="txt-address" rows="4" placeholder="Enter user address.."><?php print $resultUser[0]['address'];?></textarea>
                                                ...
                                                <select class="form-control" id="txt-institute" name="txt-institute" size="1">
                                                  ...
                                                  if($resultInst){
                                                    foreach ($resultInst as $value) {
                                                      ?>
                                                      <option value="<?php print $value['institute_id'];?>" <?php if($resultUser[0]['institute_id']==$value['institute_id']){ print "selected"; } ?>><?php print "[ ".$value['institute_id']." ] ".$value['institute_name'];?></option>
                                                      <?php
                                                    }
                                                  }
                                                  ?>
