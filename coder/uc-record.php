                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="card">
                              <div class="card-header bg-blue bg-inverse">
                                  <h4>List all patient's un-confirm record</h4>
                              </div>
                              <div class="card-block" style="padding-top: 30px;">
                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    ...
                                    <tbody>
                                      <?php
                                      $strSQL = sprintf("SELECT * FROM ".$tbprefix."registerrecord  WHERE username in (SELECT a.username FROM ".$tbprefix."useraccount a inner join ".$tbprefix."userdescription b on a.username = b.username WHERE b.institute_id = '%s') and confirm_status = 0 ORDER BY date_adm DESC ", mysql_real_escape_string($valueUserinfo['institute_id']), mysql_real_escape_string($_SESSION[$sessionName.'sessUsername']));
                                      // print $strSQL;
